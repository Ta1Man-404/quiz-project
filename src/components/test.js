    ...
    showQuestion() {
        ...
        activeQuestion.answers.forEach(answer => {
            ...
            if (chosenOption && chosenOption.chosenAnswerId === answer.id) {
                ...
                this.chosenAnswers.push(answer.id);
            }
        ...
        if (this.currentQuestionIndex === this.quiz.questions.length) {
            ...
            this.nextBtnElement.innerText = 'Далee';
        }
        ...
        if (xhr.status === 200 && xhr.responseText) {
            ...
            if (result) {
                ...
                this.userResult.forEach(item => {
                    chosenAnswers.push(item.chosenAnswerId);
                });
                location.href = '#/result?name=' + this.routeParams.name + '&lastname=' + this.routeParams.lastname + '&email=' +
                    this.routeParams.email + '&id=' + this.routeParams.id + '&score=' + result.score + '&total=' + result.total + '&chosenAnswersId=' + chosenAnswers;
            }
        } else {
            location.href = '#/';
        }
